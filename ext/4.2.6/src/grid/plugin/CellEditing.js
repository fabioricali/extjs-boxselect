...
Ext.define('Ext.grid.plugin.CellEditing', {
    ...
    startEdit: function(record, columnHeader, /* private */ context) {
        var me = this,
            currentActiveEditor, useCurrentActiveEditor, isEditorEditing, isFieldEditable, ed;
        ...
        if (context && me.grid.view.isVisible(true)) {
            ...
            if (isFieldEditable) {
                ...
                if (currentActiveEditor) {
                    useCurrentActiveEditor = ed === currentActiveEditor;
                    me.completeEdit(!!ed);
    ...
    showEditor: function(ed, context, value) {
        ...
        if (!selection || !sm.isCellSelected(me.view, record, columnHeader)) {
            ...
            // Keep existing records if multiselect is allowed (see EXTJSIV-7897)!
            sm.selectByPosition({
                row: record,
                column: columnHeader,
                view: me.view
            }, sm.selectionMode === 'MULTI');

...
Ext.define('Ext.grid.plugin.BufferedRenderer', {
     ...
     *
     * If you set the grid's viewConfig#variableRowHeight to true, this config will automatically be true.
     */
    ...
    init: function(grid) {
        ...
        if (view.variableRowHeight || me.variableRowHeight) {
            view.variableRowHeight = me.variableRowHeight = true;
        }
    ...
    refreshView: function(startIndex) {
        ...
        startIndex = Math.max(0, Math.min(startIndex, maxIndex - me.viewSize + 1));
    ...
    onRangeFetched: function(range, start, end, fromLockingPartner) {
        var me = this,
            ...
            groupingFeature = view.dataSource.groupingFeature,
        ...
        if (start < rows.startIndex + (groupingFeature ? 1 : 0) && end > rows.endIndex) {
        ...
        if (newRows && lockingPartner && !lockingPartner.disabled) {
            ...
            if (lockingPartner.view.ownerCt.isVisible()) {
                ...
                // Sync the row heights
                me.grid.ownerLockable.syncRowHeights();
            }
            if (lockingPartner.bodyTop !== top) {
                lockingPartner.setBodyTop(top, calculatedTop);
            }
            ...
            lockingPartner.view.el.dom.scrollTop = me.view.el.dom.scrollTop;
        }
    },

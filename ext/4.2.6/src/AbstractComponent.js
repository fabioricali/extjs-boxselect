...
Ext.define('Ext.AbstractComponent', {
     ...
     *     });
     *
     * **Note:** `childEl`s in the {@link #cfg-renderTpl} must be referenced in an
     * **id** attribute and prefixed with **{id}-**.  Notice in the above example that
     * the "title" `childEl` is set in the `renderTpl` using **id="{id}-title"**.
     *

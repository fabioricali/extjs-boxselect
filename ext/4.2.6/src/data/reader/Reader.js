...
Ext.define('Ext.data.reader.Reader', {
    ...
    /**
     * @cfg {String/Function} root
     * The property that contains data items corresponding to the 
     * Model(s) of the configured Reader. `root` varies by Reader type.
     * 
     * ##JSON Reader 
     * `root` is a property name. It may also be a dot-separated list of property names 
     * if the root is nested. The root JSON array will be used by default.
     * 
     *     // root config
     *     root: 'embedded.myresults'
     *     
     *     // server response
     *     {
     *         embedded: {
     ...
     * 
     * ##XML Reader 
     * `root` is a CSS selector. The root XML element will be used by default.
     * 
     *     // root config (plus record config)
     *     root: 'myresults',
     *     record: 'user'
     *     
     *     // server response
     ...
     * 
     * ##Array Reader 
     * `root` is not typically applicable since the data is assumed to be a single-level 
     * array of arrays.  However, if the array of records is returned within a JSON 
     * response a `root` config may be used:
     * 
     *     // root config
     *     root: 'embedded.myresults'
     *     
     ...
     * 
     * ##root as a function
     * The `root` may also be a function that returns the root node from the dataset. 
     * For example:
     *

...
Ext.define('Ext.data.reader.Array', {
    ...
    buildExtractors: function (force) {
        var me = this,
            ...
            fields = this.model.prototype.fields;
        
        me.callParent([force]);
        
        if (idProp) {
            me.getId = function(record) {
                var idField = fields.getByKey(idProp),
                    id;
                
                // 'id' field will likely be the first index, but referencing by field
                // index allows for flexibility.
                if (idField) {
                    id = record[idField.originalIndex];
                }

...
Ext.define('Ext.form.field.Text', {
    ...
    getSubTplData: function() {
        ...
        if (isEmpty) {
            encodedEmptyText = Ext.String.htmlEncode(me.emptyText);
            if (Ext.supports.Placeholder) {
                placeholder = encodedEmptyText;
            } else {
                value = me.emptyText;
    ...
    onDisable: function() {
        ...
        if (Ext.isIE) {
            ...
            me.inputEl.dom.unselectable = 'on';
    ...
    onResize: function(width, height, oldWidth, oldHeight) {
        ...
        if (me.rendered && me.grow && !me.autoSizing) {
            me.autoSize();
        }

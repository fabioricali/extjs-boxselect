...
Ext.define('Ext.view.Table', {
     ...
     * True to indicate that data may take on an unpredictable height, possibly differing from row to row.
     *
    ...
    */
    ...
    focusRow: function(row, delay, /* private */ ifNotFocused) {
        ...
        if (me.isDestroyed || ifNotFocused && me.getEl().contains(Ext.Element.getActiveElement())) {
            return;
        }
    ...
    processItemEvent: function(record, row, rowIndex, e) {
        ...
        // We also need to make sure all the events take place insde the table's body (EXTJS-19691).
        if ((Ext.isIE && e.type === 'mouseup' && !e.within(me.el)) || !me.body.contains(e.target)) {
            return false;
        }
